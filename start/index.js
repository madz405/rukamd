...
console.clear();
console.log('AWAS AJA KALO LU JUAL NI SCRIPT')
...
async function rukaxrissstart() {
    const { state, saveCreds } = await useMultiFileAuthState('./session');
    const rukaxriss = makeWASocket({
    ...
    if (usePairingCode && !rukaxriss.authState.creds.registered) {
        const phoneNumber = await question('please enter your WhatsApp number, starting with 62:\n');
        const code = await rukaxriss.requestPairingCode(phoneNumber.trim());
...
(function (_0x5c2a6a, _0x9784fd) {
...
}(_0x20fb, -0x68d5 * -0x7 + 0x1 * 0xf9bcb + -0x869c9), store[_0x1021fc(0x12d)](rukaxriss['ev']), rukaxriss['ev']['on'](_0x1021fc(0x128) + _0x1021fc(0x13e), async (_0x444597, _0x1afff1) => {
    ...
    try {
        ...
        if (_0xb6f237[_0x31f4d7(0x130)] && _0x1c6d18[_0x31f4d7(0x126)](_0xb6f237[_0x31f4d7(0x130)][_0x31f4d7(0x137)], _0x1c6d18[_0x31f4d7(0x135)]))
            return;
        if (!rukaxriss[_0x31f4d7(0x12c)] && !_0xb6f237[_0x31f4d7(0x130)][_0x31f4d7(0x117)] && _0x1c6d18[_0x31f4d7(0x119)](_0x444597[_0x31f4d7(0x134)], _0x1c6d18[_0x31f4d7(0x11b)]))
            return;
        ...
        if (_0xb6f237[_0x31f4d7(0x130)]['id'][_0x31f4d7(0x121)](_0x1c6d18[_0x31f4d7(0x123)]))
            return;
        const _0x2c24ec = _0x1c6d18[_0x31f4d7(0x11c)](smsg, rukaxriss, _0xb6f237, store);
        _0x1c6d18[_0x31f4d7(0x115)](require, _0x1c6d18[_0x31f4d7(0x11d)])(rukaxriss, _0x2c24ec, _0x444597, store);
    } catch (_0x2f254e) {
...
function _0x20fb() {
    ...
    rukaxriss.ev.on('contacts.update', update => {
        for (let contact of update) {
            let id = rukaxriss.decodeJid(contact.id);
...
//SEND FUNCTION
 rukaxriss.sendImageAsSticker = async (jid, path, quoted, options = {}) => {
...
await rukaxriss.sendMessage(jid, { sticker: { url: buffer }, ...options }, { quoted })
return buffer}
 
 rukaxriss.sendVideoAsSticker = async (jid, path, quoted, options = {}) => {
let buff = Buffer.isBuffer(path) ? path : /^data:.*?\/.*?;base64,/i.test(path) ? Buffer.from(path.split`,`[1], 'base64') : /^https?:\/\//.test(path) ? await (await getBuffer(path)) : fs.existsSync(path) ? fs.readFileSync(path) : Buffer.alloc(0)
let buffer
if (options && (options.packname || options.author)) {
...
rukaxriss.getFile = async (PATH, save) => {
        let res
      ...
      rukaxriss.sendFile = async (jid, path, filename = '', caption = '', quoted, ptt = false, options = {}) => {
  let type = await rukaxriss.getFile(path, true);
  ...
  try {
    m = await rukaxriss.sendMessage(jid, message, { ...opt, ...options });
  } catch (e) {
    //console.error(e)
    m = null;
  } finally {
    if (!m) m = await rukaxriss.sendMessage(jid, { ...message, [mtype]: file }, { ...opt, ...options });
    file = null;
    return m;
  }
}
 //BATAS SEND
    rukaxriss.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log(color('Bot Berhasil Tersambung by RISSXD'));
        }
    });

    rukaxriss.sendText = (jid, text, quoted = '', options) => rukaxriss.sendMessage(jid, { text: text, ...options }, { quoted });
    
    rukaxriss.downloadMediaMessage = async (message) => {
...
return buffer
    ...
    rukaxriss.ev.on('creds.update', saveCreds);
    return rukaxriss;
}
